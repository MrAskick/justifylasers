...
public final class LuminousFlux {
    ...
    public static String format(long lumens) {
        ...
        double divisor = value >= 1_000_000_000_000L ? 1_000_000_000_000L : value >= 1_000_000_000 ? 1_000_000_000 : value >= 1_000_000 ? 1_000_000 : 1_000;
        String unit = divisor == 1_000_000_000_000L ? "Tlm" : divisor == 1_000_000_000 ? "Glm" : divisor == 1_000_000 ? "Mlm" : "klm";
