...
final class NativeInventoryProbe {
    static void verify(BlockEntity block, ItemStack sample, boolean blocked) {
        ...
        for (Direction side : Direction.values()) {
            var port = block.getCapability(net.minecraftforge.common.capabilities.ForgeCapabilities.ITEM_HANDLER, side).orElse(null);
    ...
    static void verifyConfiguratorEnergy() {
        ...
        var port = stack.getCapability(net.minecraftforge.common.capabilities.ForgeCapabilities.ENERGY).orElse(null);
